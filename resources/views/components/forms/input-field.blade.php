...
<div>
    <div @class([
        ...
        @elseif ($type === 'textarea')
            <textarea name="{{ $name }}" {{ $attributes->merge() }} rows="4"
                class="resize-none peer absolute top-6 w-full bg-transparent 
                    text-sm px-3 py-2 transition duration-300
                    placeholder-transparent text-gray-800
                    focus:outline-none focus:placeholder-slate-400"></textarea>
        @endif
